          ...
          <Box display="grid" gridTemplateColumns={"1fr"} gridGap={10}>
            <Box m={2} display="grid" gridTemplateColumns="1fr 1fr 1fr" gridGap={10}>
              ...
              <TextField
                ...
                disabled
              />
              <TextField value={values.SO} name="SO" label="SO" onChange={handleChange} onBlur={handleBlur} disabled />
              <TextField
                value={values.number}
                name="number"
                label="Serial"
            ...
            >
              ...
              {help && (
                <Button onClick={deleteDocument} kind="delete" disabled={isSubmitting} style={{ alignSelf: "center" }}>
                  Delete
                </Button>
              )}
            </Box>
