...
export default function TicketForm({
  ...
  return (
    <>
      ...
      <Box width="100%">
        <FormControlLabel name="fsh" label="Help" control={<Checkbox checked={values.fsh} onChange={handleChange} />} />
        {!values.id ? (
          <>
    ...
    <Box display="grid" gridTemplateColumns={phone ? "1fr 1fr" : "1fr 1fr 1fr 1fr"} gridColumnGap={10}>
      ...
      <Box display="grid" gridTemplateColumns="1fr" gridRowGap={10} my={1}>
        ...
        <TextField
          ...
          onBlur={handleBlur}
        />
        <TextField value={values.email} name="email" label="Email" onChange={handleChange} onBlur={handleBlur} />
        <TextField value={values.phone} name="phone" label="Phone" onChange={handleChange} onBlur={handleBlur} />
        <TextField
  ...
  return (
    <Box mt={1} display="grid" gridColumnGap={10} gridRowGap={10} gridTemplateColumns="1fr 1fr">
      <TextField
        ...
        onBlur={handleBlur}
      />
      <TextField value={values.phone} name="phone" label="Contact Number" onChange={handleChange} onBlur={handleBlur} />
      <TextField
        value={values.email}
        name="email"
        label="Contact Mail"
