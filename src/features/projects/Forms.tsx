...
export const NewTask = ({ onClose, project }: IprojectModal) => {
    ...
    return (
        <Fragment>
            {project && project.id &&
                <TaskModal open={addTask} onClose={() => { setAddTask(false) }} project={project} />
            }
                                ...
                                <Box m={3} display="grid" gridTemplateColumns="1fr 1fr" gridGap={10} gridColumnGap={10}>
                                    ...
                                    {project &&
                                        <Fragment>
                                            ...
                                            <Box style={{ gridColumnEnd: "span 2", display: 'flex', justifyContent: 'center' }}>
                                                <Button onClick={() => setAddTask(true)} kind="add">Add Task</Button>
                                            </Box>
                                        </Fragment>
                                    }
                                </Box>
                                <Box style={{ display: "flex", width: "50%", margin: "0px 25%" }}>
                                    <Button type="submit" kind={project ? "edit" : "add"} disabled={isSubmitting} style={{ flex: 1 }}>
                                        Save
                                    </Button>
                                    {project && (
                                        <Button
