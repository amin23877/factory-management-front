...
export default function Details({
  ...
  return (
    <Fragment>
      ...
      {poData && poData.id && <DocModal open={addDoc} onClose={() => setAddDoc(false)} itemId={poData.id} model="po" />}
      ...
      >
        ...
        <BasePaper>
          ...
          {activeTab === 0 && (
            <BaseDataGrid cols={LICols} rows={docs} onRowSelected={onDocSelected} height="calc(100% - 60px)" />
          )}
          {activeTab === 1 && (
            <Fragment>
              <Button
              ...
              <BaseDataGrid cols={docCols} rows={docs} onRowSelected={onDocSelected} height="calc(100% - 100px)" />
            </Fragment>
          )}
          {activeTab === 2 && (
            <Fragment>
              ...
              <BaseDataGrid cols={noteCols} rows={notes} onRowSelected={onNoteSelected} height="calc(100% - 100px)" />
            </Fragment>
          )}
        </BasePaper>
      </Box>
