...
export const GeneralForm = ({
    ...
    return (
        <Box my={1} id="general">
            ...
            <Box display="flex" justifyContent="space-between">
            <TextField value={values.location} style={{ flex: 1 }} name="location" label="locaton" onChange={handleChange} onBlur={handleBlur} fullWidth />
            <TextField value={values.leadTime} style={{ flex: 1 }} name="leadTime" label="lead Time" onChange={handleChange} onBlur={handleBlur} fullWidth />
            </Box>
