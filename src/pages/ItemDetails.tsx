...
function ItemsDetails() {
  ...
  const { data: selectedRow } = useSWR<IItem>(
  ...
  const { data: itemPOs } = useSWR(
    activeTab === 7
      ? selectedRow && selectedRow.id
        ? `/item/${selectedRow.id}/purchasepo`
        : null
      : null
  );
...
=======
                  <Button
                    style={{ margin: "1.3em 43% 0.5em 43%" }}
                    kind="edit"
                    type="submit"
                  >
                    Save
                    ...
                    >
                      {selectedRow?.photo && (
                        <img
                          ...
                          alt=""
                          src={
                            img ? img : `http://${host}${selectedRow?.photo}`
                          }
                        />
                      )}
                      <UploadButton
...
>>>>>>> 9585833cade8eea72a7e1ce6bb300d270f5163ef
}
