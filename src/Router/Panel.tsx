...
const ShippingAndReceiVing = React.lazy(
  () => import("../pages/ShippingAndReceiVing")
);
          ...
          <Suspense fallback={<MyBackdrop />}>
            <Switch>
              ...
              <Route
                exact
                path="/panel/shipping"
                component={ShippingAndReceiVing}
              />
              <Route exact path="/panel/engineering" component={Engineering} />

              <Route
                exact
                path="/panel/inventory/:itemId"
                component={ItemDetails}
              />
              <Route
                exact
                path="/panel/engineering/:deviceId"
                component={DeviceDetails}
              />
              <Route
                exact
                path="/panel/production/:unitNumber"
                component={UnitDetails}
              />
              <Route
                exact
                path="/panel/quote/:quoteNumber"
                component={QuoteDetails}
              />
              <Route exact path="/panel/so/:soNumber" component={SODetails} />
              <Route
                exact
                path="/panel/customer/:cusNumber"
                component={CustomerDetails}
              />

              <Route
                exact
                path="/panel/bom/:bomId/parts"
                component={BomParts}
              />
              <Route
                exact
                path="/panel/ubom/:bomId/parts"
                component={JobParts}
              />
