    ...
    <div>
      <div className={classes.exact}>
        ...
        <div className={classes.right}>
          ...
          <div>
            <h1>Representative Order Acknowledgement</h1>
          </div>
          <div>
            <h3>050621-3PE</h3>
          </div>
      ...
      <div>
        <p className="frst-txt1">
          <b>Sales Order#:</b> 060921-1
        </p>
        <p className="frst-txt2">
          <b>Customer PO#: S6650371-PHASE 5</b>
        </p>
        <p className="frst-txt3">
          <b>PO Received Date:</b>
        </p>
        <p className="frst-txt4">
          <b>Processed By:</b>
        </p>
        <p className="frst-txt5">
          <b>Estimated Ship Date:</b>Week of 7/9/2021
        </p>
        <p className="frst-txt6">
          <b>Project Name: Alia Inverter</b>
        </p>
        <p className="frst-txt7">
          <b>Project Location:</b> San Diego
        </p>
        <p className="frst-txt8">
          <b>Bill To:</b> OneSource Distributors, LLC
          <br />
          5045 Convey St
          <br />
          San Diego, CA 92111
        ...
        <p className="frst-txt9">
          <b>Ship To:</b> CONVOY STREET
          <br />
          San Diego, CA 92111
          <br />
          Attn: BR36 ONESOURCE
        ...
        <p className="frst-txt10">
          <b>Phone:</b> (858) 564-0233
        </p>
        <p className="frst-txt11">
          <b>Ship Via:</b> Best Way
        </p>
        <p className="frst-txt12">
          <b>Freight Terms </b> Prepaid and Add
        </p>
      </div>
      ...
      <div className="boxes">
        ...
        <ul>
          ...
          <li>SF724-EWMINI1050-2KW 7 days a week, 24hrs, Except Holidays, 1 Preventive maintenance per year $ 1683</li>
          <li>
            SF365-EWMINI1050-2KW 7 days a week, 24hrs, Including Holidays, 1 Preventive Maintenance per year $ 1895
          </li>
          <li>SW58-EWMINI1050-2KW 8-5 Mon-Fri, per year $ 661</li>
          <li>SF58-EWMINI1050-2KW 8-5 Mon-Fri One (1) Preventive Maintenance per year (1) $ 1130</li>
          <li>SF724-EWMINI1050-2KW 7 days a week, 24hrs, Except Holidays, 1 Preventive maintenance per year $ 1683</li>
      ...
      <div className="box-blue1">
        <h1 className="h1-1">
          This freight quote does not include special items such as lift gates, limited access charges,
        </h1>
      ...
      <div className="boxes-txt">
        ...
        <p>Qty Unit Price Unit Total</p>
        <p>
          This freight quote does not include special items such as lift gates, limited access charges, and/or any
          <br />
          other special handling charges.
          <br />
          If extra charges occur, we will contact you to determine how to handle any additional shipping costs if
          <br />
          not already disclosed at time of order.
          <br />
        </p>
      </div>
      <div className="erea">
      ...
      <h2>NOTES:</h2>
      <p>Qty Unit Price Unit Total</p>
      1. * This is the standard lead time; please consult the factory for others.
      <br />
      a. Expediting fees are due and nonrefundable upon release of purchase order to manufacture.
      <br />
      b. DSPM will put forth the best effort possible to comply with required dates but not guaranteed.
      <br />
      ...
      <br />
      9. Freight is PREPAID AND ADD unless otherwise noted.
      <br />
      <div className="boxes-txt" style={{ fontSize: "15px" }}>
        ...
        <p>
          <br />
          <br />
          Acceptance The terms of sale contained herein apply to all sales transactions including Quotations and
          Purchase Orders entered into by Seller directly with the Buyer for standard product. Custom product sales may
          be subject to additional terms and conditions. This acceptance is conditional upon Buyer's assent to the terms
          and conditions set out herein in lieu of those in Buyer's purchase orders. Modifications or additions to these
          ...
          <br />
          <br />
          Prices Quotations automatically expire 30 days from the date issued and are subject to withdrawal or extension
          by notice within that period. Seller's published prices are subject to change without notice. New pricing will
          ...
          <br />
          <br />
          Taxes Unless otherwise agreed upon in writing or required by law, all prices will be quoted and billed
          exclusive of federal, state and local excise sales and similar taxes. Such taxes, when applicable shall appear
          as additional terms on the invoice. If exemption from such taxes is claimed, buyer must provide, or have on
          file with Seller, a certificate of exemption at the time the Purchase Order is submitted to Seller.
          <br />
          <br />
          Orders Acceptance Buyer's Purchase Orders must be in writing and approved by an authorized representative of
          the Buyer. Seller shall determine order acceptance at its discretion, and may impose restrictions for quantity
          requirements in regard to total order value and product packaging minimums. Seller can also restrict time
          frames for scheduled deliveries and change order activity. Terms of acceptance will be mutually understood by
          both parties, and authorized in writing by Seller at the Buyer's request.
          <br />
          <br />
          Terms of Payment The Seller reserves the right to require payment in advance or C.O.D. and otherwise modify
          credit terms. Unless otherwise agreed, partial shipments can be made and payment shall become due in
          accordance with the designated terms upon submission of invoices. Each shipment shall be invoiced separately
          and Buyer shall pay for each shipment as invoiced. If shipments are delayed by Buyer without Seller's prior
          written consent, payments shall become due on the date when Seller is prepared to make shipment. Products held
          for the Buyer by the Seller shall be at the risk and expense of the Buyer. Seller reserves the right to add a
          monthly service charge as allowed by law.
          <br />
          <br />
          Title and Delivery Unless otherwise instructed in writing, Seller shall ship by the methods it deems most
          advantageous. Transportation shall be collect, or if prepaid, will be subsequently billed to the Buyer. Title
          shall pass to the Buyer, and Seller's liability as to delivery shall cease on delivery of products to carrier
          at Seller's facility, regardless of any provisions for payment of freight or insurance or the form of shipping
          documents. Risk of loss or damage in transit shall rest with the Buyer. All claims for loss or damage will be
          filed with the carrier. Claims against Seller for shortages occurring before delivery to carrier shall be
          waived unless made within thirty (30) days after delivery of shipment to the Buyer.
          <br />
          <br />
          Contingencies All shipping dates and quantities are approximate. Seller shall use reasonable efforts to fill
          all orders according to the agreed upon schedule and quantity. Seller shall not be responsible for any failure
          to perform resulting from unforeseen circumstances or causes beyond Seller's reasonable control. Such causes
          include, but are not limited to; strikes, floods, fires, labor disputes, accidents, inability to maintain
          materials or supplies, excessive demand for products over the available supply, custom duties or surcharges,
          and interruption for any reason in the manufacture of Seller's products by Seller's suppliers, any act of God,
          or the action of any government. In the event of any delay caused by such a contingency, the date of delivery
          shall, at the request of the Seller be deferred for period equal to the period of delay.
          <br />
          <br />
          Patents Buyer shall indemnify, defend and hold Seller harmless against all expenses, damages, costs, or losses
          ...
          <br />
          <br />
          Warranty and Sole Remedy For the applicable warranty period specified below, Seller warrants that the products
          to be delivered hereunder will be free from defects in materials and workmanship under normal use and service.
          The obligations of the Seller under this warranty are limited to replacing, repairing or giving credit for, at
          its option, any of said products which shall, within the warranty period be returned as provided herein to the
          Seller, transportation charges prepaid and which are, after examination, disclosed to the satisfaction of the
          Seller to be thus defective. Buyer acknowledges and agrees that the provisions of this warranty constitute the
          sole and exclusive remedy available to it with regard to said defective products. No agent, employee, or
          ...
          <br />
          <br />
          provided herein, Buyer agrees to reimburse Seller for all reasonable expenses incurred in traveling and/or
          ...
          <br />
          <br />
          Product Discontinuance Seller will give as much notification as possible in the event of discontinuing
          product, however, Seller reserves the right to discontinue production of any product at any time without
          notice except for that quantity of product for which Seller has received and acknowledged a Purchase Order
          from Buyer and has scheduled such product for shipment within six (6) months of the date of such
          acknowledgement.
          <br />
          <br />
          Cancellation of Buyer Orders for standard product may be cancelled on sixty (60) days prior to the scheduled
          ship date by written notice to Seller. Orders for products which are not listed in Seller’s current catalogue
          (including but not limited to, semi-custom application specific products, or other semi-custom product(s)
          which have special markings, or which have received special testing or which are specially programmed for
          Buyer) may not be cancelled or returned except under the provisions of a prior written agreement between
          Seller and Buyer which sets forth the cancellation charges to be paid by Buyer in the vent of such
          cancellation. If such an agreement is not in place, the charges shall be 100%. Any money paid in advance is
          refundable at DSPM discretion.
          <br />
          <br />
          Property Rights The design, development or manufacture by Seller of a product for Buyer shall not be deemed to
          produce a work made for hire and shall not give to Buyer any copyright interest in the product or any interest
          in all or any portion of the mask works relating to the product. All such rights remain with the property of
          the Seller including models, drawings, composites, patterns, dies molds, masks and any other tools made for or
          obtained for furnishing the products hereunder.
          <br />
          <br />
          Special, Incidental, Consequential, or Indirect Damages INDEPENDENTLY OF ANY OTHER LIMITATION HEREOF AND
          REGARDLESS OF WHETHER THE PURPOSE OF SUCH LIMITATION IS SERVED, IT IS AGREED THAT IN NO EVENT SHALL SELLER BE
          LIABLE FOR SPECIAL, INCIDENTAL, CONSEQUENTIAL OR INDIRECT DAMAGES.
          <br />
          <br />
          Limitation of Actions No action against Seller for breach hereof shall be commenced more than one (1) year
