  ...
  return (
    <div>
      ...
      <div className={classes.divider}>
        <div className={classes.column}>
          <table style={{ minHeight: "100px" }}>
            ...
            <td className={classes.td}>OneSource Distributors, LLC 5045 Convey St San Diego, CA 92111</td>
          </table>
          <br />
          <table>
            <tr>
        ...
        <div className={classes.column}>
          <table style={{ minHeight: "100px" }}>
            ...
            <td className={classes.td}>BR36 ONESOURCE 5045 CONVOY STREET San Diego, CA 92111</td>
          </table>
          <br />
          ...
          <table>
            ...
            <tr>
              ...
              <td className={classes.td} style={{ fontSize: "small", padding: "0px" }}>
                {" "}
                WESTERN Lighting and Controls{" "}
              </td>
            </tr>
            <tr>
              <th className={classes.th} style={{ width: "50%" }}>
      ...
      <table style={{ width: "100%" }}>
        ...
        <tbody>
          {data?.lines?.flat()?.map((item: any, i: any) => (
            <tr key={i}>
              <td>{i}</td>
              <td>{item.qty}</td>
              <td>{item.ItemObject?.no || ""}</td>
              <td>{item.ItemObject?.description || item.text || ""}</td>
      ...
      <div style={{ marginBottom: "100px" }}>
        PLEASE MARK ALL PACKAGES WITH JOB NAME AND TYPE DELIVERY DOCK AROUND BACK OF BUILDING
      </div>
    </div>
  );
}
